...
def load_kit(inputFile):
    ...
    while True:
        try:
            ...
            break
    inputFile.close()
    dev.write_binary_values(
        "INPUCALK", data, is_big_endian=True, header_fmt="hp", datatype="b"
    )
...
def save_kit(outputFile, beep=False):
    ...
    data = dev.query_binary_values(
        "OUTPCALK", is_big_endian=True, header_fmt="hp", datatype="c"
    )
...
parser.add_argument(
    ...
    nargs="?",
    default="save",
    help="valid commands are: load, save, default and kits. save is the default",
)
parser.add_argument(
    "genders",
    type=valid_genders,
...
parser.add_argument(
    "-u", metavar="unit", default="8722", help="unit to connect to: 8753 or 8722"
)
parser.add_argument(
    "-k", metavar="kit", default="3.5mm", help="calkit to use as default: SMA or 3.5mm"
)
